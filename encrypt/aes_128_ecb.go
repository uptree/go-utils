...
// AesECBEncrypt 加密 => MYSQL AES_ENCRYPT
...
// AesECBDecrypt 解密 => MYSQL AES_DECRYPT
...
// AesECBEncryptMsg 加密+base64编码 => MYSQL TO_BASE64(AES_ENCRYPT)
func AesECBEncryptMsg(msg, key string) string {
	encrypted := AesECBEncrypt([]byte(msg), []byte(key))
	if encrypted == nil {
		return ""
	}
...
// AesECBDecryptMsg 解密+base64编码
func AesECBDecryptMsg(msg, key string) string {
